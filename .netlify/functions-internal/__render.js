...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-d5b1df86.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-d5b1df86.js", "/./_app/chunks/vendor-21f1eab5.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-b2e58b8e.js", "css": ["/./_app/assets/pages/__layout.svelte-aa3b5abc.css"], "js": ["/./_app/pages/__layout.svelte-b2e58b8e.js", "/./_app/chunks/vendor-21f1eab5.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-274d4084.js", "css": [], "js": ["/./_app/error.svelte-274d4084.js", "/./_app/chunks/vendor-21f1eab5.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-31b4d7e4.js", "css": ["/./_app/assets/pages/index.svelte-d8eb68ab.css"], "js": ["/./_app/pages/index.svelte-31b4d7e4.js", "/./_app/chunks/vendor-21f1eab5.js"], "styles": null }, "src/routes/about.svelte": { "entry": "/./_app/pages/about.svelte-63c8c049.js", "css": ["/./_app/assets/pages/about.svelte-84e910ab.css"], "js": ["/./_app/pages/about.svelte-63c8c049.js", "/./_app/chunks/vendor-21f1eab5.js"], "styles": null }, "src/routes/blog/index.svelte": { "entry": "/./_app/pages/blog/index.svelte-0fac140f.js", "css": ["/./_app/assets/pages/blog/index.svelte-d6c6a5c9.css"], "js": ["/./_app/pages/blog/index.svelte-0fac140f.js", "/./_app/chunks/vendor-21f1eab5.js"], "styles": null }, "src/routes/blog/relearn-css-pt-1.md": { "entry": "/./_app/pages/blog/relearn-css-pt-1.md-b5b1824d.js", "css": [], "js": ["/./_app/pages/blog/relearn-css-pt-1.md-b5b1824d.js", "/./_app/chunks/vendor-21f1eab5.js"], "styles": null }, "src/routes/blog/relearn-css-pt-2.md": { "entry": "/./_app/pages/blog/relearn-css-pt-2.md-1293c458.js", "css": [], "js": ["/./_app/pages/blog/relearn-css-pt-2.md-1293c458.js", "/./_app/chunks/vendor-21f1eab5.js"], "styles": null }, "src/routes/blog/[slug].svelte": { "entry": "/./_app/pages/blog/[slug].svelte-f4922560.js", "css": ["/./_app/assets/pages/blog/[slug].svelte-b79566c9.css"], "js": ["/./_app/pages/blog/[slug].svelte-f4922560.js", "/./_app/chunks/vendor-21f1eab5.js"], "styles": null } };
...
var css$4 = {
  code: "section.svelte-rxah4f{margin-bottom:1rem}p.svelte-rxah4f{margin:1em auto;font-size:1.3em;text-align:left}span.svelte-rxah4f{text-decoration:line-through}",
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<svelte:head>\\n\\t<title>Joshua Swiss's Site</title>\\n\\t<script src=\\"https://identity.netlify.com/v1/netlify-identity-widget.js\\">\\n\\t<\/script>\\n</svelte:head>\\n\\n<main id=\\"main\\">\\n\\t<section>\\n\\t\\t<p>\\n\\t\\t\\tHey there! I'm Josh, <span>a software engineer</span> an engineering manager based in Glasgow.\\n\\t\\t\\tThis is my site to showcase my professional skillz &trade; and blather about whatever I find interesting,\\n\\t\\t\\twhether that be code or anything else.\\n\\t\\t</p>\\n\\t</section>\\n\\t<section>\\n\\t\\t<p>\\n\\t\\t\\tIf you want to learn more about my work and expertise, please check out the\\n\\t\\t\\t<a href=\\"about\\">About</a>\\n\\t\\t\\tpage. If you want to read about whatever; JavaScript, Rust, fermentation, running, life, etc.,\\n\\t\\t\\tplease check out my\\n\\t\\t\\t<a href=\\"blog\\">Blog</a>\\n\\t\\t\\t.\\n\\t\\t</p>\\n\\t</section>\\n</main>\\n\\n<style>\\n\\tsection {\\n\\t\\tmargin-bottom: 1rem;\\n\\t}\\n\\n\\tp {\\n\\t\\tmargin: 1em auto;\\n\\t\\tfont-size: 1.3em;\\n\\t\\ttext-align: left;\\n\\t}\\n\\tspan {\\n\\t\\ttext-decoration: line-through;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA2BC,OAAO,cAAC,CAAC,AACR,aAAa,CAAE,IAAI,AACpB,CAAC,AAED,CAAC,cAAC,CAAC,AACF,MAAM,CAAE,GAAG,CAAC,IAAI,CAChB,SAAS,CAAE,KAAK,CAChB,UAAU,CAAE,IAAI,AACjB,CAAC,AACD,IAAI,cAAC,CAAC,AACL,eAAe,CAAE,YAAY,AAC9B,CAAC"}`
};
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$4);
  return `${$$result.head += `${$$result.title = `<title>Joshua Swiss&#39;s Site</title>`, ""}<script src="${"https://identity.netlify.com/v1/netlify-identity-widget.js"}" data-svelte="svelte-e5snac"><\/script>`, ""}

<main id="${"main"}"><section class="${"svelte-rxah4f"}"><p class="${"svelte-rxah4f"}">Hey there! I&#39;m Josh, <span class="${"svelte-rxah4f"}">a software engineer</span> an engineering manager based in Glasgow.
			This is my site to showcase my professional skillz \u2122 and blather about whatever I find interesting,
			whether that be code or anything else.
		</p></section>
	<section class="${"svelte-rxah4f"}"><p class="${"svelte-rxah4f"}">If you want to learn more about my work and expertise, please check out the
			<a href="${"about"}">About</a>
			page. If you want to read about whatever; JavaScript, Rust, fermentation, running, life, etc.,
			please check out my
			<a href="${"blog"}">Blog</a>
...
var css = {
  code: "section.svelte-1yi8a0w pre{background-color:#f9f9f9;box-shadow:inset 1px 1px 5px rgba(0, 0, 0, 0.05);padding:0.5em;border-radius:2px;overflow-x:auto}section.svelte-1yi8a0w pre code{background-color:transparent;padding:0}section.svelte-1yi8a0w ul{line-height:1.5}section.svelte-1yi8a0w li{margin:0 0 0.5em 0}section.svelte-1yi8a0w img{max-width:fit-content;height:auto}section.svelte-1yi8a0w twitter-widget{max-width:fit-content;height:auto}h2.svelte-1yi8a0w{margin-bottom:2rem;display:inline;text-align:center;font-size:4rem;font-family:'Gilroy'}",
  map: `{"version":3,"file":"[slug].svelte","sources":["[slug].svelte"],"sourcesContent":["<script context=\\"module\\" lang=\\"ts\\">var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\\n    return new (P || (P = Promise))(function (resolve, reject) {\\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\\n        function rejected(value) { try { step(generator[\\"throw\\"](value)); } catch (e) { reject(e); } }\\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\\n    });\\n};\\nexport function load({ page, fetch }) {\\n    return __awaiter(this, void 0, void 0, function* () {\\n        const post = yield fetch(\`\${page.path}.json\`).then((res) => res.json());\\n        if (!post || !post.published) {\\n            return {\\n                status: 404,\\n                error: new Error('Post could not be found')\\n            };\\n        }\\n        return {\\n            props: {\\n                post\\n            }\\n        };\\n    });\\n}\\n<\/script>\\n\\n<script lang=\\"ts\\">export let post;\\n<\/script>\\n\\n<svelte:head>\\n\\t<title>{post.title}</title>\\n\\t<meta name=\\"keywords\\" content={post.tags} />\\n\\t<meta name=\\"description\\" content={post.summary} />\\n</svelte:head>\\n\\n<h2>{post.title}</h2>\\n\\n<section>\\n\\t<slot />\\n</section>\\n\\n<style>\\n\\tsection :global(pre) {\\n\\t\\tbackground-color: #f9f9f9;\\n\\t\\tbox-shadow: inset 1px 1px 5px rgba(0, 0, 0, 0.05);\\n\\t\\tpadding: 0.5em;\\n\\t\\tborder-radius: 2px;\\n\\t\\toverflow-x: auto;\\n\\t}\\n\\tsection :global(pre) :global(code) {\\n\\t\\tbackground-color: transparent;\\n\\t\\tpadding: 0;\\n\\t}\\n\\tsection :global(ul) {\\n\\t\\tline-height: 1.5;\\n\\t}\\n\\tsection :global(li) {\\n\\t\\tmargin: 0 0 0.5em 0;\\n\\t}\\n\\tsection :global(img) {\\n\\t\\tmax-width: fit-content;\\n\\t\\theight: auto;\\n\\t}\\n\\tsection :global(twitter-widget) {\\n\\t\\tmax-width: fit-content;\\n\\t\\theight: auto;\\n\\t}\\n\\th2 {\\n\\t\\tmargin-bottom: 2rem;\\n\\t\\tdisplay: inline;\\n\\t\\ttext-align: center;\\n\\t\\tfont-size: 4rem;\\n\\t\\tfont-family: 'Gilroy';\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA2CC,sBAAO,CAAC,AAAQ,GAAG,AAAE,CAAC,AACrB,gBAAgB,CAAE,OAAO,CACzB,UAAU,CAAE,KAAK,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CACjD,OAAO,CAAE,KAAK,CACd,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,AACjB,CAAC,AACD,sBAAO,CAAC,AAAQ,GAAG,AAAC,CAAC,AAAQ,IAAI,AAAE,CAAC,AACnC,gBAAgB,CAAE,WAAW,CAC7B,OAAO,CAAE,CAAC,AACX,CAAC,AACD,sBAAO,CAAC,AAAQ,EAAE,AAAE,CAAC,AACpB,WAAW,CAAE,GAAG,AACjB,CAAC,AACD,sBAAO,CAAC,AAAQ,EAAE,AAAE,CAAC,AACpB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AACpB,CAAC,AACD,sBAAO,CAAC,AAAQ,GAAG,AAAE,CAAC,AACrB,SAAS,CAAE,WAAW,CACtB,MAAM,CAAE,IAAI,AACb,CAAC,AACD,sBAAO,CAAC,AAAQ,cAAc,AAAE,CAAC,AAChC,SAAS,CAAE,WAAW,CACtB,MAAM,CAAE,IAAI,AACb,CAAC,AACD,EAAE,eAAC,CAAC,AACH,aAAa,CAAE,IAAI,CACnB,OAAO,CAAE,MAAM,CACf,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,QAAQ,AACtB,CAAC"}`
};
...
<h2 class="${"svelte-1yi8a0w"}">${escape2(post.title)}</h2>

<section class="${"svelte-1yi8a0w"}">${slots.default ? slots.default({}) : ``}
</section>`;
});
